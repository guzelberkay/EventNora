...
const Index = () => {
  ...
  const pageTitle = t('Event Planning & Organization | Event Nora', 'Etkinlik Planlama & Organizasyon | Event Nora');
  const pageDescription = t(
      'We design unforgettable events through creativity, strategy, and flawless execution.',
      'Yaratıcılık, strateji ve kusursuz uygulama ile unutulmaz etkinlikler tasarlıyoruz.'
  );
        ...
        <section className="section bg-white">
          <div className="container-custom">
            ...
            <span className="text-gold font-medium">
              {t('Why Choose Us', 'Neden Bizi Seçmelisiniz')}
            </span>
              <h2 className="heading-2 text-black mt-2 mb-4">
                {t('The Golden Standard in Event Planning', 'Etkinlik Planlamada Altın Standart')}
              </h2>
          ...
          <div className="container-custom relative z-10">
            <div className="max-w-3xl mx-auto text-center">
              <h2 className="text-3xl md:text-4xl font-bold text-white mb-6">
                ...
                <span className="text-gold">{t('Memorable', 'Oluşturmaya')}</span>
                {t(' Event?', ' Hazır Mısınız?')}
              </h2>
              <p className="text-white/80 text-lg mb-8">
                {t(
                    'Contact us today to discuss your event needs and let us bring your vision to life.',
                    'Etkinlik ihtiyaçlarınızı görüşmek ve vizyonunuzu hayata geçirmek için hemen bizimle iletişime geçin.'
                )}
              </p>
              <Link
                  to="/contact"
