...
const WhatsAppFloat = () => {
  const phoneNumber = "+905327701208"; // Replace with your WhatsApp number
  const message = "📩 Merhaba, EventNora Sizden organizasyon hizmetleri hakkında bilgi almak istiyorum."; // Default message
  ...
  <QueryClientProvider client={queryClient}>
    <TooltipProvider>
      <LanguageProvider>
        ...
        <Sonner />
        <BrowserRouter>
          {/* WhatsApp button rendered outside Routes so it appears on all pages */}
          <WhatsAppFloat />
          <Routes>
            ...
            <Route path="/services/:slug" element={<ServiceDetail />} /> {/* Fallback için */}
